...
Trino (ранее известный как Presto) — это распределенный SQL-движок, разработанный для выполнения запросов к большим
...
данных, файловые системы и облачные хранилища.

Trino использует коннекторы для взаимодействия с этими источниками данных.

Коннекторы позволяют Trino выполнять SQL-запросы к данным, независимо от их местоположения и формата. Это делает
